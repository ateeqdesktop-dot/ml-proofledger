...
All notable changes to ML ProofLedger are documented here.

The project follows a lightweight Keep a Changelog style, and versions use Semantic Versioning where releases are created.
